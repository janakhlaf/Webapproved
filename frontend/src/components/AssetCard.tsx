...
export function AssetCard({ asset, onClick }: AssetCardProps) {
  ...
  return (
    ...
    >
      ...
      <TiltCard className="h-full flex flex-col cursor-none">
        {/* ─── Premium Glassmorphic Card ─── */}
        <Card className="relative overflow-hidden rounded-2xl bg-[#080c14]/90 backdrop-blur-xl border border-cyan-500/15 hover:border-cyan-400/50 transition-all duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.85)] h-full flex flex-col justify-between cursor-none glass-glare-card">
          ...
          <div className="relative aspect-square bg-[#03050a]/90 overflow-hidden border-b border-white/5 cyber-scanlines">
          ...
          <div className="p-5 flex-grow flex flex-col justify-between space-y-4 bg-gradient-to-b from-transparent to-[#03050a]/40 relative z-10">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-white/5">
              ...
              <Button
                size="sm"
                className="px-4 transition-all duration-300 bg-cyan-400 text-black hover:bg-cyan-300 hover:text-black shadow-[0_0_15px_rgba(0,240,255,0.25)] font-bold border-none"
                onClick={handleCardClick}
              >
                Get Asset
              </Button>
