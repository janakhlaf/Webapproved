  ...
  return (
    <>
      ...
      <div
        ref={cursorRef}
        id="cursor"
        className="fixed pointer-events-none z-[9999] rounded-full -translate-x-1/2 -translate-y-1/2 transition-[width,height,background-color] duration-150"
        style={{
          width: '8px',
          height: '8px',
          ...
          left: '-20px',
          top: '-20px',
          boxShadow: '0 0 10px rgba(0, 240, 255, 0.75), 0 0 20px rgba(0, 240, 255, 0.4)',
        }}
      />
      <div
        ref={cursorRingRef}
        id="cursor-ring"
        className="fixed pointer-events-none z-[9998] rounded-full -translate-x-1/2 -translate-y-1/2 opacity-60 transition-all duration-[0.08s] ease-out"
        style={{
          width: '32px',
          height: '32px',
